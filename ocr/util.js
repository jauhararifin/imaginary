...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'util.wast';
  var wasmBinaryFile = 'util.wasm';
  var asmjsCodeFile = 'util.temp.asm.js';
...
var real__rgb_to_grayscale = asm["_rgb_to_grayscale"]; asm["_rgb_to_grayscale"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__rgb_to_grayscale.apply(null, arguments);
};

var real__rgba_to_grayscale = asm["_rgba_to_grayscale"]; asm["_rgba_to_grayscale"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__rgba_to_grayscale.apply(null, arguments);
};
...
var _rgb_to_grayscale = Module["_rgb_to_grayscale"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_rgb_to_grayscale"].apply(null, arguments) };
var _rgba_to_grayscale = Module["_rgba_to_grayscale"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_rgba_to_grayscale"].apply(null, arguments) };
